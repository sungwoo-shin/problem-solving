...
export var empty = function () { return __generator(this, function (_a) {
    return [2 /*return*/];
}); };
// eslint-disable-next-line @typescript-eslint/no-empty-function
export var asyncEmpty = function () { return __asyncGenerator(this, arguments, function () { return __generator(this, function (_a) {
    return [2 /*return*/];
}); }); };
export var isNotNullable = function (a) {
    return a !== null && a !== undefined;
};
export var isPromise = function (a) {
