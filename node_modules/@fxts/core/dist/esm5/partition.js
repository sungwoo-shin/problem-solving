...
function partition(f, iterable) {
    ...
    if (isAsyncIterable(iterable)) {
        ...
        return group.then(function (group) { return [
            group["true"] || [],
            group["false"] || [],
        ]; });
    }
