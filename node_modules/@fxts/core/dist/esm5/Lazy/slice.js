import { __asyncGenerator, __asyncValues, __await, __awaiter, __generator, __values } from "tslib";
...
function asyncSequential(start, end, iterable) {
    return __asyncGenerator(this, arguments, function asyncSequential_1() {
        var i, _a, iterable_2, iterable_2_1, item, e_2_1;
        var _b, e_2, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    if (!(iterable_2_1 = _e.sent(), _b = iterable_2_1.done, !_b)) return [3 /*break*/, 8];
                ...
                case 10:
                    ...
                    return [4 /*yield*/, __await(_c.call(iterable_2))];
                case 11:
                    _e.sent();
                    _e.label = 12;
