import { __asyncGenerator, __asyncValues, __await, __awaiter, __generator, __read, __values } from "tslib";
...
function asyncSequential(f, iterable) {
    return __asyncGenerator(this, arguments, function asyncSequential_1() {
        var _a, iterable_1, iterable_1_1, item, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    if (!(iterable_1_1 = _e.sent(), _b = iterable_1_1.done, !_b)) return [3 /*break*/, 7];
                ...
                case 9:
                    ...
                    if (!(!_a && !_b && (_c = iterable_1.return))) return [3 /*break*/, 11];
                    return [4 /*yield*/, __await(_c.call(iterable_1))];
                case 10:
                    _e.sent();
                    _e.label = 11;
