...
function asyncSequential(iterable) {
    return tslib_1.__asyncGenerator(this, arguments, function asyncSequential_1() {
        var arr, _a, iterable_2, iterable_2_1, a, e_3_1, arr_2, arr_2_1, a, e_4_1;
        var e_4, _b;
        var _c, e_3, _d, _e;
        return tslib_1.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    if (!(iterable_2_1 = _f.sent(), _c = iterable_2_1.done, !_c)) return [3 /*break*/, 7];
                    _e = iterable_2_1.value;
                    _a = false;
                    a = _e;
                ...
                case 9:
                    ...
                    if (!(!_a && !_c && (_d = iterable_2.return))) return [3 /*break*/, 11];
                    return [4 /*yield*/, tslib_1.__await(_d.call(iterable_2))];
                case 10:
                    _f.sent();
                    _f.label = 11;
