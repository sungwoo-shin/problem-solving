...
function asyncSequential(f, iterable) {
    return tslib_1.__asyncGenerator(this, arguments, function asyncSequential_1() {
        var iterator, iterableIterator, _a, iterableIterator_2, iterableIterator_2_1, a, e_2_1;
        var _b;
        var _c, e_2, _d, _e;
        return tslib_1.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    ...
                    _a = true, iterableIterator_2 = tslib_1.__asyncValues(iterableIterator);
                    _f.label = 2;
                case 2: return [4 /*yield*/, tslib_1.__await(iterableIterator_2.next())];
                case 3:
                    if (!(iterableIterator_2_1 = _f.sent(), _c = iterableIterator_2_1.done, !_c)) return [3 /*break*/, 10];
                    _e = iterableIterator_2_1.value;
                    _a = false;
                    a = _e;
                ...
                case 7: return [4 /*yield*/, tslib_1.__await.apply(void 0, [_f.sent()])];
                case 8:
                    _f.sent();
                    _f.label = 9;
                case 9:
                ...
                case 12:
                    ...
                    if (!(!_a && !_c && (_d = iterableIterator_2.return))) return [3 /*break*/, 14];
                    return [4 /*yield*/, tslib_1.__await(_d.call(iterableIterator_2))];
                case 13:
                    _f.sent();
                    _f.label = 14;
