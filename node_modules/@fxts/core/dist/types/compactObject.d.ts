...
type RequiredKeys<T extends object, U = MapRequiredKeys<T>> = Exclude<U[keyof U], never>;
type OptionalKeys<T extends object, U = MapOptionalKeys<T>> = Exclude<U[keyof U], never>;
type NonNullableEntries<T extends object, U = MapNonNullableEntries<T>> = Exclude<U[keyof U], [any, never]>;
/**
