...
type HasPromise<T extends any[]> = Head<T> extends never ? false : Head<T> extends Promise<unknown> ? true : T["length"] extends 0 ? false : HasPromise<Tail<T>>;
...
type ReturnPipeType<T extends any[], R = Awaited<PipeLast<T>>> = HasPromise<T> extends true ? Promise<R> : PossiblyHasPromise<T> extends true ? Promise<R> | R : R;
export default ReturnPipeType;
//# sourceMappingURL=ReturnPipeType.d.ts.map